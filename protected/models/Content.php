...
class Content extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('layout_id, content_title, content_title_slug, content_desc, isactive, meta_description', 'required'),
			array('layout_id, isactive', 'numerical', 'integerOnly'=>true),
			array('content_title, content_title_slug, meta_key, meta_title', 'length', 'max'=>500),
			array('created_by, updated_by', 'length', 'max'=>255),
            array('content_title_slug', 'unique', 'className' => 'Content', 'attributeName' => 'content_title_slug', 'message'=>'This slug is already in use'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('content_id, layout_id, content_title, content_title_slug, content_desc, meta_key, meta_title, meta_description, isactive, created_on, created_by, updated_on, updated_by', 'safe', 'on'=>'search'),
		);
	}
