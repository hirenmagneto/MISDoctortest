...
<?php if(Yii::app()->user->getId()!=null) { ?>
	<div id="topnav">
		<div class="topnav_text"><a href='<?php echo Yii::app()->baseUrl; ?>/dashboard/index'>Home</a> | <a href='<?php echo Yii::app()->baseUrl; ?>/admin/logout'>Logout</a> </div>
	</div>
 <?php } ?>
	<div id="header">
		<div id="logo"><a href="<?php echo Yii::app()->baseUrl; ?>/dashboard/index"><img src="<?php echo Yii::app()->baseUrl; ?>/images/logo.png"></img></a><?php //echo CHtml::encode(Yii::app()->name); ?></div>
	</div><!-- header -->
    <!--
<?php /*$this->widget('application.extensions.mbmenu.MbMenu',array(
	...
	<div id="mainmenu">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Layout', 'url'=>array('/layout/admin')),
				array('label'=>'Content', 'url'=>array('/content/admin')),
				array('label'=>'Test Category', 'url'=>array('/testcategory/admin')),
				//array('label'=>'Content', 'url'=>array('/test/admin')),
				array('label'=>'News', 'url'=>array('/news/admin')),
				array('label'=>'FAQ', 'url'=>array('/faq/admin')),
				array('label'=>'Gallary', 'url'=>array('/gallary/admin')),
				array('label'=>'Test', 'url'=>array('/test/admin')),
				array('label'=>'Test Question', 'url'=>array('/testQuestion/admin')),
				array('label'=>'Contact Us logs', 'url'=>array('/contactUs/admin')),
			),
		)); ?>
	</div> <!--mainmenu -->
    <?php } ?>
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by advaning.com<br/>
