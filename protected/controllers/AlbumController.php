...
class AlbumController extends Controller
{
	...
	public function actionDelete($id)
	{
        ...
        unlink(Yii::app()->basePath . '/../images/album/layout/'.$delete->image_type_id.'/'.$delete->image_name);
        unlink(Yii::app()->basePath . '/../images/album/layout/'.$delete->image_type_id.'/thumbs/'.$delete->image_name);
        $delete->delete();
        echo '';
