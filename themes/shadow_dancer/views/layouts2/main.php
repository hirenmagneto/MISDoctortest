...
<?php if(Yii::app()->user->getId()!=null) { ?>
	<div id="topnav">
		<div class="topnav_text"><a href='<?php echo Yii::app()->baseUrl; ?>/dashboard/index'>Home</a> | <a href='<?php echo Yii::app()->baseUrl; ?>/site/logout'>Logout</a> </div>
	</div>
 <?php } ?>
	<div id="header">
	...
	<div id="mainmenu">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Fabric', 'url'=>array('/fabric/admin')),				
